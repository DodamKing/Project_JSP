...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/css/main.css?ver=6">
...
<body>
    ...
    <script src="<%=request.getContextPath() %>/js/main.js?ver=6"></script>
    <script src="<%=request.getContextPath() %>/js/player.js?ver=8"></script>
</body>
